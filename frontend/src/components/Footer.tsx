        ...
        <div className="footer-content">
          ...
          <div className="footer-column">
            ...
            <div className="footer-links">
              ...
              <Link href="/webhooks" className="footer-link">
                Webhooks
              </Link>
              <Link href="/sdk" className="footer-link">
                SDK
                <span className="coming-soon">Soon</span>
              </Link>
          ...
          <div className="footer-column">
            ...
            <div className="footer-links">
              <a href="mailto:support@neuroip.xyz" className="footer-link">
                support@neuroip.xyz
              </a>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            ...
            <div className="powered-by">
              Powered by{" "}
              <a href="https://storyprotocol.xyz" target="_blank" rel="noopener noreferrer" className="protocol-link">
                Story Protocol
              </a>
            </div>
          </div>
